        ...
        <footer className="bg-neutral-900 text-neutral-300 border-t border-white/10 relative overflow-hidden">
            ...
            <Container className="py-16 md:py-20 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <Link href="/" className="inline-block">
                            <h3 className="text-2xl font-bold text-white tracking-tight">Noor Al Khan</h3>
                        </Link>
                        <p className="text-neutral-400 leading-relaxed max-w-sm">
                            Your trusted partner for premium commercial printing, packaging, and branding solutions in the UAE. Delivering quality and speed since establishment.
                        </p>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <a href="mailto:info@nooralkhan.com" className="text-neutral-400 hover:text-brand-primary transition-colors relative group py-1.5 inline-block">
                                    Get a Quote
                                    <span className="absolute bottom-0 left-0 w-full h-0.5 bg-brand-primary scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
                                </a>
                            </li>
                ...
                <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-neutral-500">
                    <p>© {new Date().getFullYear()} Noor Al Khan Printing. All rights reserved.</p>
